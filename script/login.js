...
var LoginHandler = (function () {
    function LoginHandler(savehandler, server) {
        ...
        this.logInButton.click(function () {
            setTimeout(function () {
                that.logInButton.removeClass("ui-btn-active");
            }, 100);
        });
        ...
        this.createUserButton.click(function () {
            setTimeout(function () {
                that.createUserButton.removeClass("ui-btn-active");
            }, 100);
        });
    ...
    LoginHandler.prototype.isOffline = function () {
        this.setStatus(3);
    };
    LoginHandler.prototype.setStatus = function (status) {
        this.status = status;
        if(status == 1) {
